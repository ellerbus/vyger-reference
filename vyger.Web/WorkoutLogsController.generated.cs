...
namespace vyger.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_WorkoutLogsController : vyger.Web.Controllers.WorkoutLogsController
    {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, vyger.Web.Models.WorkoutLogForm post, System.DateTime? date);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(vyger.Web.Models.WorkoutLogForm post, System.DateTime? date)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
        ...
        [NonAction]
        partial void PlansOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int plan, int cycle, int week, int day);

        [NonAction]
        public override System.Web.Mvc.ActionResult Plans(int plan, int cycle, int week, int day)
        {
