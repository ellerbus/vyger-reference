...
namespace vyger.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_WorkoutPlanExercisesController : vyger.Web.Controllers.WorkoutPlanExercisesController
    {
        public T4MVC_WorkoutPlanExercisesController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int id, int cycle);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(int id, int cycle)
        {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int id, int cycle, vyger.Common.Models.WorkoutPlanCycle post);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(int id, int cycle, vyger.Common.Models.WorkoutPlanCycle post)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "cycle", cycle);
