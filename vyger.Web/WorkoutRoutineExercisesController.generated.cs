...
namespace vyger.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_WorkoutRoutineExercisesController : vyger.Web.Controllers.WorkoutRoutineExercisesController
    {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int id, int week, vyger.Web.Models.WorkoutRoutineExerciseForm post);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(int id, int week, vyger.Web.Models.WorkoutRoutineExerciseForm post)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "week", week);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "post", post);
            IndexOverride(callInfo, id, week, post);
            return callInfo;
        }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int id, int day, vyger.Web.Models.WorkoutRoutineExerciseForm post);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(int id, int day, vyger.Web.Models.WorkoutRoutineExerciseForm post)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "day", day);
        ...
        [NonAction]
        partial void DeleteOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int id, int day, int exercise, vyger.Web.Models.WorkoutRoutineExerciseForm post);

        [NonAction]
        public override System.Web.Mvc.ActionResult Delete(int id, int day, int exercise, vyger.Web.Models.WorkoutRoutineExerciseForm post)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Delete);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "day", day);
